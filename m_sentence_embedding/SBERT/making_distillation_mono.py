...
student_model_name = 'nreimers/BERT-Tiny_L-2_H-128_A-2'       
...
model_save_path = f"output/making/making_mono-T-{teacher_model_name.replace('/','-')}-S-{student_model_name.replace('/','-').replace('simcse_original','').replace('output','').replace('--','-')}"
