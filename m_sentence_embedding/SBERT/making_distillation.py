...
teacher_model_name = 'sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2' # sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2, sentence-transformers/bert-base-nli-stsb-mean-tokens
...
output_path = f"output/making/making-T-{teacher_model_name.replace('/','-')}-S-{student_model_name.replace('/','-')}"
